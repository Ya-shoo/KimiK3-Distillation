...
| § | Section | Argues / contains | Pulls from |
|---|---|---|---|
...
### §7 Results — the five sub-results (each is a chart + a claim)
...
### §9 Risk checklist (address each explicitly — naming them is the credibility move)
...
## Part B — Findings the 4090 must LOG during training (feeds §7.3, §7.4, §10)
